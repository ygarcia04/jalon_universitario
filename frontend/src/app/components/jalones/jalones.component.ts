...
@Component({
  selector: 'abe-jalones',
  templateUrl: './jalones.component.html',
  styleUrls: ['./jalones.component.scss']
})
export class JalonesComponent implements OnInit {
...
constructor(
  ...
  ngOnInit(): void {
    ...
    this.authService.jalonesAceptadosRechazadosUser()
    .subscribe(
      res=>{
