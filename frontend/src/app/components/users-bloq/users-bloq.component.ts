...
@Component({
  selector: 'abe-users-bloq',
  templateUrl: './users-bloq.component.html',
  styleUrls: ['./users-bloq.component.scss']
})
export class UsersBloqComponent  implements OnInit {
...
ngOnInit() {
  ...
  this.authService.viewUsersBloq()
  .subscribe(
    res=>{
