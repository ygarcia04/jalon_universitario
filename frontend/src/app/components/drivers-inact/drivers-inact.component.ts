...
@Component({
  selector: 'abe-drivers-inact',
  templateUrl: './drivers-inact.component.html',
  styleUrls: ['./drivers-inact.component.scss']
})
export class DriversInactComponent implements OnInit {
...
this.authService.viewDriversInact()
.subscribe(
  res=>{
...
verificar(correo){
  console.log(correo);
  this.router.navigate(['/verific-driver'])
