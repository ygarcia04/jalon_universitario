...
@Component({
  selector: 'abe-users-inact',
  templateUrl: './users-inact.component.html',
  styleUrls: ['./users-inact.component.scss']
})
export class UsersInactComponent  implements OnInit {
...
ngOnInit() {
  ...
  this.authService.viewUsersInact()
  .subscribe(
    res=>{
