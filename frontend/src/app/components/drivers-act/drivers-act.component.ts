...
@Component({
  selector: 'abe-drivers-act',
  templateUrl: './drivers-act.component.html',
  styleUrls: ['./drivers-act.component.scss']
})
export class DriversActComponent implements OnInit {
...
//Listener para hacer la busqueda dinamica que no requiera un boton
 @HostListener('input') oninput() {
  ...
  ngOnInit(): void {
    ...
    this.authService.viewDriversAct()
    .subscribe(
      res=>{
