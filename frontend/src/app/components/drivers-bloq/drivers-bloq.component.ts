...
@Component({
  selector: 'abe-drivers-bloq',
  templateUrl: './drivers-bloq.component.html',
  styleUrls: ['./drivers-bloq.component.scss']
})
export class DriversBloqComponent implements OnInit {
 ...
 ngOnInit() {
   ...
   this.authService.viewDriversBloq()
   .subscribe(
     res=>{
