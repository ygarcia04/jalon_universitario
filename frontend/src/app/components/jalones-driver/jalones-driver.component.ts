...
@Component({
  selector: 'abe-jalones-driver',
  templateUrl: './jalones-driver.component.html',
  styleUrls: ['./jalones-driver.component.scss']
})
export class JalonesDriverComponent implements OnInit {
...
//Arreglo de cabeceras de la tabla
  headElements = ['ID', 'Nombre', 'Apellido', 'Facultad', 'Direccion de Salida','Hora de Salida','Ruta','Descripcion', 'Estado'];
...
constructor(
  ...
  ngOnInit(): void {
    ...
    this.authService.jalonesAceptadosRechazadosDriver()
    .subscribe(
      res=>{
